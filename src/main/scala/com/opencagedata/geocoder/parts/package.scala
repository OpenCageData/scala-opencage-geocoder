...
package object parts {
  ...
  @ConfiguredJsonCodec case class Components(iso3166Alpha2Code: Option[String],
  ...
  @ConfiguredJsonCodec case class Currency(alternateSymbols: Option[List[String]],
  ...
  @ConfiguredJsonCodec case class SunTimings(apparent: Instant,
  ...
  @ConfiguredJsonCodec case class Timezone(name: String,
                                           nowInDst: Boolean,
                                           offsetSec: Int,
                                           offsetString: Int,
                                           shortName: String)

  @ConfiguredJsonCodec case class Annotations(currency: Option[Currency],
                                              dms: Option[DMS],
                                              mgrs: Option[String],
                                              osm: Option[OSM],
  ...
  @ConfiguredJsonCodec case class Result(annotations: Option[Annotations],
