...
import com.opencage.geocoder.OpenCageClient.Scheme.Scheme
 ...
 * @param hostname Defaults to com.opencage.geocoder.OpenCageClient#defaultHostname(), but can be
...
class OpenCageClient(authKey: String,
   ...
   * @param lat latitude
   * @param lng longitude
   * @param params Allows you to specify additional parameters to the call. @see com.opencage.geocoder.OpenCageClientParams
